...
The docs site serves an agent-readable Markdown twin of every page: `/llms.txt` indexes every component with its import name, and `/components/<slug>.md` is the full page. The index is generated by `packages/demo/src/pages/components.md.ts` — nothing to regenerate by hand.
