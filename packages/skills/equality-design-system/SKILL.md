...
| Footer action or "Select all" in a searchable menu         | A `persistent` item, with `useDropdownMenuSearchQuery` to act on the matches | Buttons outside the menu items |
