...
Column `content` accepts any `ReactNode`, so you can use components like [`<SortButton>`](/components/sort-button) in column headers to add interactive sort controls.
