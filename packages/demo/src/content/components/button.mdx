...
It is the only filled variant with dark text. Yellow is too light to carry white legibly, so `button-warning-text` is black where the other fills use white.
