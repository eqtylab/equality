...
<div className="grid grid-cols-[auto_auto_auto] gap-6">
  ...
  <div className="flex flex-col items-start space-y-3">
    ...
    <Badge variant="neutral" icon="Circle" display="icononly" />
    <Badge variant="primary" icon="Shield" display="icononly" />
    <Badge variant="warning" icon="OctagonAlert" display="icononly" />
    <Badge variant="danger" icon="TriangleAlert" display="icononly" />
    <Badge variant="success" icon="Check" display="icononly" />
  </div>
</div>
