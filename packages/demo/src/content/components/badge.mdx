...
The Badge comes in two sizes. The default `md` size is 20px tall, while `sm` is 16px tall for use in tighter layouts where very density is desired such as log viewers.
