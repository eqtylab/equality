...
A confirmation dialog that blocks interaction until the user acknowledges it. Unlike Dialog, clicking the overlay won't dismiss it — the user must choose an action.
