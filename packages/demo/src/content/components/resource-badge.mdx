...
| --------- | --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- | -------- |
| `type`    | The resource type that determines the badge variant, icon, and label. | `"agent"`, `"benchmark"`, `"benchmark-result"`, `"binary"`, `"code"`, `"compute"`, `"database"`, `"dataset"`, `"document"`, `"guardrail"`, `"model"`, `"prompt"`, `"system-prompt"`, `"reasoning"`, `"config"`, `"token"`, `"tool"`, `"unknown"` |          | ✅       |
