...
<div className="grid grid-cols-[auto_auto_auto] gap-6">
  ...
  <div className="flex flex-col items-start space-y-3">
    ...
    <ResourceBadge type="systemprompt" display="text-only" />
    ...
    <ResourceBadge type="systemparameters" display="text-only" />
  ...
  <div className="flex flex-col items-start space-y-3">
    ...
    <ResourceBadge type="systemprompt" display="icon-only" />
    ...
    <ResourceBadge type="systemparameters" display="icon-only" />
