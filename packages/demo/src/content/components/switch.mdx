...
<SwitchDemo client:only="react" variant="red" />

### Lilac

<SwitchDemo client:only="react" variant="lilac" />

### Blue

<SwitchDemo client:only="react" variant="blue" />

### Green

<SwitchDemo client:only="react" variant="green" />

### Yellow

<SwitchDemo client:only="react" variant="yellow" />
