...
| `lineNumbers` | `boolean`                                                              | `false`     | Number every line in a gutter. Long lines scroll instead of wrapping while set.       |
