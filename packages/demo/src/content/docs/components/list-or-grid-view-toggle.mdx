...
description: "Deprecated List or Grid View Toggle with sizes and variants"
deprecated:
  message: 'Deprecated in favour of <a href="/components/segmented-controls">Segmented Controls</a>.'
---
