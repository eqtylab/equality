...
A confirmation dialog that blocks interaction until the user acknowledges it. Unlike [Dialog](/components/dialog), clicking the background overlay won't dismiss it — the user must choose an action.
