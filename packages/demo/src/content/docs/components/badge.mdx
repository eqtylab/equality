...
For control compliance and resource types see [ControlStatusBadge](/components/control-status-badge) and [ResourceBadge](/components/resource-badge) respectively.
