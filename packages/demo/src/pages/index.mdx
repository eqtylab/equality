...
- **Dynamic theming** through the `ThemeProvider` or a theming data attribute (light, dark, custom)
...
Equality UI is framework-agnostic — it works seamlessly in **Vite**, **Next.js**, and **Astro** environments. Just wrap your app with the `<ThemeProvider>` (or apply theming manually - see [Themes](/getting-started/themes)) and import the components you need — everything else is automatic.
