...
You can override specific tokens using the `customVars` prop on `ThemeProvider`:
...
You can override specific tokens by applying CSS var overrides where the theme is set:
