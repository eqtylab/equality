...
- **Self-contained** – scoped styles via CSS modules
...
The theme stylsheet injects all design tokens as CSS custom properties:
...
…those variables are updated, and every component automatically restyles itself — no rebuilds, no extra logic.
