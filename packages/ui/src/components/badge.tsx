...
const badgeVariants = cva(
  'focus:ring-ring focus:outline-hidden inline-flex items-center rounded-full border px-2 py-0.5 text-xs font-medium transition-colors focus:ring-2 focus:ring-offset-2',
  {
    variants: {
      variant: {
